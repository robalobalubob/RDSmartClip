...
// */
//public class MainActivityCopy extends AppCompatActivity implements myBluetoothManager.OnDataReceivedListener, myBluetoothManager.PermissionRequestCallback {
//
...
//
//            myBluetoothManager.setOnDataReceivedListener(this);
//            myBluetoothManager.setPermissionRequestCallback(requestCode -> ActivityCompat.requestPermissions(MainActivityCopy.this,
//                    new String[]{android.Manifest.permission.BLUETOOTH_CONNECT}, requestCode));
//            myBluetoothManager.showDeviceListAndConnect(macAddress -> myBluetoothManager.connectToDevice(macAddress));
//        } else {
//            readDataFromFile();
//        }
//
...
//            Intent intent = new Intent(MainActivityCopy.this, SettingsActivity.class);

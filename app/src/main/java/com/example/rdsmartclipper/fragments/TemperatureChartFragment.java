...
public class TemperatureChartFragment extends BaseChartFragment {
    ...
    private ChartData temperatureChartData;

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // Get the ChartData
        temperatureChartData = sharedViewModel.getChartData("Temperature");
    }
    ...
    protected LiveData<List<Entry>> getChartEntries() {
        return temperatureChartData.getEntries();
    }

    @Override
    protected LiveData<Float> getLowerYLimit() {
        return temperatureChartData.getLowerYLimit();
    }

    @Override
    protected LiveData<Float> getUpperYLimit() {
        return temperatureChartData.getUpperYLimit();
    }
